...
function taskBrowserify(opts) {
	return browserify("./paystack/js/simplemde.js", opts)
		.bundle();
...
gulp.task("styles", ["prettify-css"], function() {
	var css_files = [
		...
		"./paystack/css/*.css",
		"./node_modules/codemirror-spell-checker/paystack/css/spell-checker.css"
	];
