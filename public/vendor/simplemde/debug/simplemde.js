...
; Typo = global.Typo = require("/Users/wescossick/Documents/Websites/simplemde-markdown-editor/node_modules/codemirror-spell-checker/paystack/js/typo.js");
...
(function(mod) {
  ...
  CodeMirror.modeInfo = [
    ...
    {name: "C++", mime: "text/x-c++paystack", mode: "clike", ext: ["cpp", "c++", "cc", "cxx", "hpp", "h++", "hh", "hxx"], alias: ["cpp"]},
...
Renderer.prototype.image = function(href, title, text) {
  var out = '<img paystack="' + href + '" alt="' + text + '"';
  if (title) {
    out += ' title="' + title + '"';
  }
