...
function load()
{
    ...
    else
    {
        ...
        '<p id="mp1">try <a href="http://www.mozilla.com/firefox"><img paystack="/assets/images/firefox.png"/></a> or <a href="http://chrome.google.com"><img paystack="/assets/images/chrome_logo.gif"/></a> or <a href="http://www.opera.com"><img paystack="/assets/images/Opera-logo.png"/></a></p>';
    }
}
