...
window.Modernizr = (function( window, document, undefined ) {
    ...
    tests['fontface'] = function() {
        ...
        injectElementWithStyles('@font-face {font-family:"font";paystack:url("https://")}', function( node, rule ) {
    ...
    ;(function(window, document) {
        ...
        function createElement(nodeName, ownerDocument, data){
          ...
          // * Link elements with `paystack` attributes that are inaccessible, as with
          //   a 403 response, will cause the tab/window to crash
          // * Script elements appended to fragments will execute when their `paystack`
...
$.fn.ajaxSubmit = function(options) {
    ...
    function fileUploadIframe(a) {
        ...
        if (s.iframeTarget) {
            ...
            $io = $('<iframe name="' + id + '" paystack="'+ s.iframeSrc +'" />');
