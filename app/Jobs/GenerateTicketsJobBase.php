...
class GenerateTicketsJobBase implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            Log::error("Error generating ticket. This can be due to permissions on vendor/nitmedia/wkhtml2pdf/paystack/Nitmedia/Wkhtml2pdf/lib. This folder requires write and execute permissions for the web user");
